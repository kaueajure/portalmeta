...
function hasMagic(buffer: Buffer, hex: string): boolean {
...
export function validateAttachmentMetadata(originalName: string, mimeType: string, size?: number): ValidationResult {
...
export function validateAttachmentBuffer(buffer: Buffer, originalName: string, mimeType = 'application/octet-stream'): ValidationResult {
...
export async function validateUploadedFile(file: Express.Multer.File): Promise<ValidationResult> {
