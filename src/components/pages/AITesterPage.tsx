...
export const AITesterPage: React.FC<AITesterPageProps> = ({ currentUser }) => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "model",
      text: `Olá, ${currentUser.nome}! Eu sou o Tique, seu assistente de Inteligência Artificial no Portal Meta.
  ...
  return (
    <div className="flex h-full min-h-0 w-full flex-col">
      <PageShell
        ...
        subtitle="O seu assistente inteligente integrado do Portal Meta"
        actions={
