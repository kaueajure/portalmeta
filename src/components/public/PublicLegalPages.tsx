...
const contactEmail = 'contato@portalmeta.com.br';
  ...
  return (
    <div className="flex flex-col bg-white">
      <LegalHero
        ...
        description="Esta Politica descreve como o Portal Meta coleta, usa, armazena, protege, compartilha e exclui dados tratados na plataforma, incluindo dados recebidos por canais de e-mail."
        icon={ShieldCheck}
      />
      ...
      <main className="px-6 py-12 bg-white">
        <div className="max-w-4xl mx-auto grid gap-10">
          ...
          <Section title="1. Controlador e escopo desta Politica">
            <p>
              O Portal Meta e uma plataforma SaaS de gestao de atendimento, tickets, SLA, portal do cliente,
            ...
            <p>
              ...
              clientes e representantes. O Portal Meta trata esses dados para executar a plataforma, manter a
          ...
          <Section title="4. Canais de e-mail">
            <p>
              ...
              no seu proprio provedor de e-mail para que mensagens recebidas sejam processadas pelo Portal Meta.
              O envio de respostas e mensagens transacionais usa a configuracao SMTP da plataforma.
            </p>
            <p>
              O Portal Meta usa os dados de e-mail apenas para criar, atualizar e preservar o historico dos tickets,
          ...
          <Section title="9. Uso proibido dos dados">
            <p>
              Dados tratados pelo Portal Meta nao podem ser usados por clientes ou usuarios para spam, assedio, fraude,
  ...
  return (
    <div className="flex flex-col bg-white">
      <LegalHero
        ...
        title="Termos de Uso"
        description="Estes Termos definem regras para acesso, uso, responsabilidades, limitacoes e integracoes do Portal Meta por empresas, usuarios internos e clientes finais autorizados."
        icon={FileText}
      />
      ...
      <main className="px-6 py-12 bg-white">
        <div className="max-w-4xl mx-auto grid gap-10">
          <div className="rounded-xl border border-blue-100 bg-blue-50 p-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm font-semibold leading-relaxed text-blue-900">
                Ao acessar ou usar o Portal Meta, voce confirma que leu, compreendeu e aceita estes Termos.
          ...
          <Section title="1. Objeto e natureza do servico">
            <p>
              O Portal Meta e uma plataforma SaaS para gestao de atendimento, tickets, SLA, portal do cliente,
          ...
          <Section title="4. Uso permitido e condutas proibidas">
            <p>
              O Portal Meta deve ser usado exclusivamente para atendimento, suporte, gestao operacional e comunicacao
          ...
          <Section title="5. Integracoes de e-mail">
            ...
            <p>
              ...
              suspensoes, mudancas de politica ou indisponibilidades que estejam fora do controle do Portal Meta.
            </p>
          </Section>
          ...
          <Section title="6. Obrigacoes da empresa sobre e-mail e dados de clientes">
            <BulletList
              items={[
                ...
                'Nao usar o Portal Meta para monitoramento secreto, vigilancia indevida ou tratamento incompatavel com leis de privacidade e trabalho.',
          ...
          <Section title="10. Propriedade intelectual">
            <p>
              O Portal Meta, incluindo marca, software, codigo, design, textos, fluxos, documentacao, interfaces,
          ...
          <Section title="12. Privacidade e protecao de dados">
            <p>
              O tratamento de dados pessoais e dados de e-mail e regulado pela Politica de Privacidade do Portal Meta,
