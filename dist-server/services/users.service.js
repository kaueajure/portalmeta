...
class UsersService {
    ...
    async create(data) {
        ...
        const [result] = await pool.query('INSERT INTO usuarios (nome, email, senha_hash, cargo, telefone, administrador, desenvolvedor, ativo, perfil, access_profile_id) VALUES (?, ?, ?, ?, ?, ?, ?, 1, ?, ?)', [nome, email, hash, cargo, telefone, administrador ? 1 : 0, desenvolvedor ? 1 : 0, perfilFinal, access_profile_id || null]);
