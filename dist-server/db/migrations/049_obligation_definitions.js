...
export async function up(connection) {
  ...
  `);
    for (const [index, definition] of DEFAULT_OBLIGATION_DEFINITIONS.entries()) {
        await connection.query(`INSERT INTO obligation_definitions
       ...
       ON DUPLICATE KEY UPDATE name = VALUES(name), frequency = VALUES(frequency),
         color = VALUES(color), competences_json = VALUES(competences_json), system = 1`, [definition.code, definition.name, definition.frequency, definition.color,
